...
#data of surface temperature deal with the same timeline of wildfire (summer 2019)   
  ...
  #check correlation between surface temperature and albedo
  #resize by resample function one of two reaster stack
  albedo_resample<-resample(albedo_2019,surface_temp, method="bilinear")
  #correlation test
  cor.test(values(albedo_resample),values(surface_temp))